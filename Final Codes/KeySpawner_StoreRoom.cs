...
public class KeySpawner_StoreRoom : MonoBehaviour
{
    ...
    void SpawnKeyOnce()
    {
        ...
        {
            Debug.LogWarning("Store Room KeySpawner is missing keyPrefab or spawnPoints.");
            return;
        }

        int randomIndex = Random.Range(0, spawnPoints.Length);
        currentKey = Instantiate(keyPrefab, spawnPoints[randomIndex].position, Quaternion.identity);
        Debug.Log("Store Room key spawned at: " + spawnPoints[randomIndex].name);
    }
}
