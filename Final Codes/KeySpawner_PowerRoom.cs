...
public class KeySpawner_PowerRoom : MonoBehaviour
{
    ...
    void SpawnKeyOnce()
    {
        ...
        {
            Debug.LogWarning("Power Room KeySpawner is missing keyPrefab or spawnPoints.");
            return;
        }

        int randomIndex = Random.Range(0, spawnPoints.Length);
        currentKey = Instantiate(keyPrefab, spawnPoints[randomIndex].position, Quaternion.identity);
        Debug.Log("Power Room key spawned at: " + spawnPoints[randomIndex].name);
    }
}
